...
from pratama.models import Transaksi, DetailTransaksi
...
from pratama.forms import CartAddProductForm 
from pratama.keranjang import Cart
import datetime
...
class CheckoutView(View): 
    ...
    def post(self, request): 
        ...
        messages.success(request, 
                         'Pesanan Anda akan segera diproses, silakan tunggu akan ada respon selanjutnya!') 
        return render(request, 'checkout.html', context, status=400)
